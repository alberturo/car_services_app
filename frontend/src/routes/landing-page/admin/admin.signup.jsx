        ...
        <div className="mx-auto max-w-lg">
          ...
          >
            ...
            <button
              ...
              type="submit"
            >
              <span className="absolute w-full inset-0 bg-gradient-to-r from-yellow-600 to-blue-500 transition-transform group-hover:translate-y-0 group-hover:translate-x-0 rounded-full"></span>

              <span className="relative w-full inline-block border-2 border-current px-5 py-2 text-sm font-bold uppercase tracking-widest text-white bg-gradient-to-r from-yellow-500 to-blue-500 rounded-full shadow-lg group-active:text-opacity-75 transition-transform transform hover:scale-105">
                Create A New Admin
              </span>
            </button>
